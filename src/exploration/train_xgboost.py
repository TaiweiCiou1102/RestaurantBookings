...
Usage:
    uv run python -m src.exploration.train_xgboost --granularity hour
    uv run python -m src.exploration.train_xgboost --granularity half_hour --tune
    uv run python -m src.exploration.train_xgboost --granularity hour --config configs/xgb_v2.yaml
"""
