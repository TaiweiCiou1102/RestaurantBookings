...
Usage:
    uv run python -m src.exploration.train_random_forest --granularity hour
    uv run python -m src.exploration.train_random_forest --granularity half_hour --tune
    uv run python -m src.exploration.train_random_forest --granularity hour --config configs/rf_v2.yaml
"""
